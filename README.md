...
`texo install` is idempotent. For each selected agent it creates an independent
...
[BATPAK-SCALEOUT-COMPOSITION.md](docs/BATPAK-SCALEOUT-COMPOSITION.md) for the
