import{a as e,r as t}from"./brands.CtB5xb0H.js";import{n,r}from"./wasm-dispatch.DAusd6yg.js";import{t as i}from"./projection.FtIQGdek.js";import{a,i as o,n as s,o as c,r as l,s as u,t as d}from"./boundary.BX1ZwV_I.js";import{t as f}from"./plan.ClalsVhr.js";import{ar as p,fr as m,ir as h,r as g,sr as _}from"./page.DJh9l2y9.js";var v=e=>e,y=-1/0;function b(e,t){let n=new Map,r=[],i=new Float64Array(t);i.fill(y);let a={name:e,capacity:t,_dense:!0,entityToIndex:n,indexToEntity:r,data:i,count:0,get(e){let t=n.get(e);if(t!==void 0)return i[t]},set(o,s){let c=n.get(o);if(c!==void 0){i[c]=s;return}if(a.count>=t)throw m(`Part.dense`,`store "${e}" at capacity (${t}). Cannot add entity ${o}. Create the store with a larger capacity (Part.dense(name, n)) or remove entities before adding.`);c=a.count,n.set(o,c),r[c]=o,i[c]=s,a.count++},has(e){return n.has(e)},delete(e){let t=n.get(e);if(t===void 0)return!1;let o=a.count-1;if(t!==o){let e=r[o];i[t]=i[o],r[t]=e,n.set(e,t)}return i[o]=y,r.length=o,n.delete(e),a.count--,!0},reset(){n.clear(),r.length=0,i.fill(y),a.count=0},view(){return i.subarray(0,a.count)},entities(){return r}};return a}function x(e,t){return b(e,t)}var S={dense:x},C=128;function w(e){return f.make(e).step(`compute-discrete`,{type:`noop`},{phase:`compute-discrete`}).step(`compute-blend`,{type:`noop`},{phase:`compute-blend`}).step(`emit-css`,{type:`noop`},{phase:`emit-css`}).step(`emit-glsl`,{type:`noop`},{phase:`emit-glsl`}).step(`emit-wgsl`,{type:`noop`},{phase:`emit-wgsl`}).step(`emit-aria`,{type:`noop`},{phase:`emit-aria`}).seq(`step-1`,`step-2`).par(`step-2`,`step-3`).par(`step-2`,`step-4`).par(`step-2`,`step-5`).par(`step-2`,`step-6`).build()}function T(e){let t=f.topoSort(e).sorted,n=new Map(e.steps.map(e=>[e.id,e]));return t.map(e=>n.get(e)?.metadata?.phase).filter(e=>typeof e==`string`)}var E=w(`czap-runtime`),D=T(E);function ee(e){let t=e?.name??`czap-runtime`,n=t===E.name?E:{...E,name:t},r=D,i=S.dense(`state-index`,e?.capacity??C),a=S.dense(`dirty-epoch`,e?.capacity??C),o=new Map,s=0,c=e=>o.get(e);return{plan:n,phases:r,stores:{stateIndex:i,dirtyEpoch:a},reset(e){o.clear(),s=0,i.reset(),a.reset();for(let t of e??[])this.registerQuantizer(t.name,t.states)},registerQuantizer(e,t){let n=c(e);if(n)return n.entityId;let r=v(`runtime-${++s}`),l=Object.create(null);for(let e=0;e<t.length;e++)l[t[e]]=e;return o.set(e,{entityId:r,stateLookup:l}),i.set(r,0),a.set(r,1),r},removeQuantizer(e){let t=c(e);t&&(o.delete(e),i.delete(t.entityId),a.delete(t.entityId))},hasQuantizer(e){return o.has(e)},setState(e,t){let n=c(e);n&&i.set(n.entityId,n.stateLookup[t]??0)},applyState(e,t){let n=c(e);if(!n)return 0;let r=n.stateLookup[t]??0;return i.set(n.entityId,r),r},getStateIndex(e){let t=c(e);return t?i.get(t.entityId):0},markDirty(e){let t=c(e);t&&a.set(t.entityId,a.get(t.entityId)+1)},getDirtyEpoch(e){let t=c(e);return t?a.get(t.entityId):0},registeredNames(){return Array.from(o.keys())}}}var te={create:ee};function ne(e,t,n){return{type:e,states:t,ack:n}}var re=`
"use strict";
...
`;function Q(e,t,n){n&&n.length>0?e.postMessage(t,n):e.postMessage(t)}function Ge(e){let t=new Blob([We],{type:`application/javascript`}),n=URL.createObjectURL(t),r=new Worker(n,{type:`classic`,name:`czap-renderer`});URL.revokeObjectURL(n);let i=new Set,a=new Set;return r.addEventListener(`message`,e=>{let t=e.data;if(!(!t||typeof t.type!=`string`))switch(t.type){case`frame`:for(let e of i)e(t.output);break;case`render-complete`:for(let e of a)e(t.totalFrames);break;case`error`:h.error({source:`czap/worker.render-worker`,code:`worker-message-error`,message:`Render worker reported an error.`,detail:{code:t.code,message:t.message,hint:t.hint}});break}}),r.addEventListener(`error`,e=>{h.error({source:`czap/worker.render-worker`,code:`worker-unhandled-error`,message:`Render worker raised an unhandled error.`,detail:e.message})}),Q(r,e===void 0?{type:`init`}:{type:`init`,config:e}),{get worker(){return r},transferCanvas(e){Q(r,{type:`transfer-canvas`,canvas:e},[e])},startRender(e){Q(r,{type:`start-render`,config:e})},stopRender(){Q(r,{type:`stop-render`})},onFrame(e){return i.add(e),()=>{i.delete(e)}},onComplete(e){return a.add(e),()=>{a.delete(e)}},dispose(){Q(r,{type:`dispose`}),i.clear(),a.clear(),r.terminate()}}}var Ke={create:Ge};function qe(e,n){let r=Ue.create(e,n),i=null,a=null,o=[];return{get compositor(){return r},get renderer(){return i},attachCanvas(t){i===null&&(i=Ke.create(e)),a={width:t.width,height:t.height};let n=t.transferControlToOffscreen();i.transferCanvas(n)},startRender(e){if(i===null||a===null)throw _(`WorkerHost.canvas`,`cannot start render -- no canvas attached. Call attachCanvas() first.`);let n={durationMs:t(e.durationMs),fps:e.fps??60,width:e.width??a.width,height:e.height??a.height};i.startRender(n)},stopRender(){i!==null&&i.stopRender()},onState(e){let t=r.onState(e);return o.push(t),()=>{let e=o.indexOf(t);e>=0&&o.splice(e,1),t()}},dispose(){for(let e of o)e();o.length=0,r.dispose(),i!==null&&(i.dispose(),i=null)}}}var Je={create:qe};function $(e,t){let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(let r of n)if(e[r]!==t[r])return!1;return!0}function Ye(e,t){let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(let r of n)if(e[r]!==t[r])return!1;return!0}function Xe(e,t){return Array.isArray(e)||Array.isArray(t)?!Array.isArray(e)||!Array.isArray(t)||e.length!==t.length?!1:e.every((e,n)=>e===t[n]):e===t}function Ze(e,t){let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(let r of n){let n=t[r];if(n===void 0||!Xe(e[r],n))return!1}return!0}function Qe(e,t){return e?$(e.discrete,t.discrete)&&$(e.aria,t.aria)&&$(Object.fromEntries(Object.entries(e.css).map(([e,t])=>[e,String(t)])),Object.fromEntries(Object.entries(t.css).map(([e,t])=>[e,String(t)])))&&Ye(e.glsl,t.glsl)&&Ze(e.wgsl,t.wgsl):!1}function $e(){return typeof Worker<`u`&&typeof SharedArrayBuffer<`u`&&globalThis.crossOriginIsolated}function et(t,n){let r=a(n.getAttribute(`data-czap-boundary`));if(!r)return;let i=null,f=null,p=null,m=null,g=null,_=null,v=n.getAttribute(`data-czap-state`)??``,y=null,b=0,x=0,S=!1,C=()=>{i?.(),i=null,p?.(),p=null,m?.(),m=null,g&&_&&typeof _.removeEventListener==`function`&&_.removeEventListener(`message`,g),g=null,_=null,f?.dispose(),f=null},w=()=>c(r.input),T=()=>{let e=(e=!1)=>{if(!r)return;let t=w();if(t===void 0)return;let i=e?l(r,t):l(r,t,v);i!==v&&(v=i,d(n,r,{discrete:{[r.name]:i}},`czap:worker-state`))};e(!0),r&&(i=s(r.input,()=>e(!1)))},E=()=>{if(!r)return;let t=r,a=Je.create();f=a;let c=(n,r,i=!1)=>{let o=[{name:t.name,state:e(n),generation:r}];if(S=!0,b=r,x=r,i){a.compositor.bootstrapResolvedState(o);return}a.compositor.applyResolvedState(o)},u=(e,r)=>{let i={discrete:{[t.name]:e}};d(n,t,i,`czap:worker-state`),v=e,y=o(i),x=r};a.compositor.addQuantizer(t.name,{id:t.boundary.id,states:t.boundary.states.map(t=>e(t)),thresholds:t.boundary.thresholds});let h=e=>{e.data?.type===`ready`&&n.dispatchEvent(new CustomEvent(`czap:worker-ready`,{bubbles:!0}))};g=h,_=a.compositor.worker,a.compositor.worker.addEventListener(`message`,h),m=a.compositor.onResolvedStateAck(e=>{if(f!==a||r!==t)return;let n=e.states.find(e=>e.name===t.name)?.state;S&&e.additionalOutputsChanged===!1&&e.generation===b&&n!==void 0&&n===v&&(S=!1)}),p=a.onState(e=>{let r=e.discrete?.[t.name];r&&(v=r);let i=o(e),a=e.resolvedStateGenerations?.[t.name];if(S&&a!==void 0&&a===b&&r===y?.discrete[t.name]&&Qe(y,i)){S=!1;return}d(n,t,e,`czap:worker-state`),y=i,a!==void 0&&(x=a,S=!1)});let C=()=>{if(f!==a||r!==t)return;let e=w();if(e===void 0)return;let n=l(t,e,v||void 0);if(n===v)return;let i=x+1;u(n,i),c(n,i)},T=w();if(T!==void 0){let e=l(t,T,v||void 0);u(e,1),c(e,1,!0)}i=s(t.input,C)},D=()=>{if(r&&u(r.input,{source:`czap/astro.worker`,what:`boundary signal`}),!$e()){h.warnOnce({source:`czap/astro.worker`,code:`worker-runtime-unavailable`,message:`Worker runtime unavailable (crossOriginIsolated=${String(globalThis.crossOriginIsolated)}, SharedArrayBuffer=${typeof SharedArrayBuffer<`u`}). Fix: czap({ workers: { enabled: true } }) — COOP/COEP response headers are emitted automatically.`}),T();return}try{E();return}catch(e){h.warn({source:`czap/astro.worker`,code:`worker-host-fallback`,message:`WorkerHost could not initialize, falling back to main-thread evaluation.`,detail:e instanceof Error?e.message:String(e)})}T()};n.addEventListener(`czap:reinit`,()=>{C(),r=a(n.getAttribute(`data-czap-boundary`)),v=n.getAttribute(`data-czap-state`)??``,y=null,b=0,x=0,S=!1,m=null,D()}),n.addEventListener(`czap:teardown`,()=>{C()}),D(),t()}var tt=(e,t,n)=>{g(`worker`,e,t,n,(e,t,n)=>{et(e,n)})};export{tt as default};